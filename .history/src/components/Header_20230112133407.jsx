        ...
        <header className=' flex justify-between items-center px-3 py-2 '>
            ...
            <div>
                <ul className='flex '>
                    ...
                    <li className={`cursor-pointer px-2 py-3 text-sm font-semibold text-gray-400 border-b-[3px] border-b-transparent 
                    ${pathMathRoute('/offers') && 'text-black border-b-blue-600'}`} onClick={()=> navigate('/offers')}>Offers</li>
                    <li className={ `cursor-pointer py-3 text-sm font-semibold text-gray-400 border-b-[3px] border-b-transparent 
                    ${pathMathRoute('/sign-in') && 'text-black border-b-blue-600'}`} onClick={()=> navigate('/sign-in')}>Sign in</li>
                </ul>
            </div>
        </header>
    </div>
