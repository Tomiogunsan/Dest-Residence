    ...
    {landlord !== null && (
        <div className='flex flex-col w-full '>
            ...
            <div className=''>
                ...
                text-xl text-gray-700 border border-gray-300 rounded transition duration-150 
            ...
            <a href={`mailto:${landlord.email}?Subject=${listing.name}&body=${message}`}>
               <button type='button'
                className=' mb-6 bg-blue-600 text-white px-7 py-3 rounded text-sm
                uppercase shadow-md hover:bg-blue-700 hover:shadow-lg
                focus:bg-blue-700 focus:shadow-lg 
                active:shadow-lg active:bg-blue-700 transition duration-150 ease-in-out
                w-full text-center ' >
                Send Message
                </button> 
            </a>
