        ...
        <header className='flex justify-between items-center px-3 py-2 max-w-[1260px]  mx-auto'>
            ...
            <div>
                <ul className='flex space-x-10'>
                    <li className={`5py-3 text-sm font-semibold text-gray-400 border-b-[3px] border-b-transparent 
                    ${pathMathRoute('/') && 'text-black border-b-blue-600'}`}>Home</li>
                    <li className={`cpy-3 text-sm font-semibold text-gray-400 border-b-[3px] border-b-transparent 
