            ...
            className='w-full px-4 py-2 text-xl text-gray-700 bg-white border
             ...
             <div>
                <div className=''>
                    ...
                    required
                    className='px-4 py-2 text-xl text-gray-700 bg-white border border-gray-700
                    rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-'/>
                </div>
