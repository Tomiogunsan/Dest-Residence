...
export default function CreateListing() {
  ...
  async function onSubmit (e) {
    ...
    //   let api = 'wuywhbjkkkk'
    //   const response = await fetch(`https://maps.googleapis.com/map/api/geocode/json?address=${address}&key=${api}`)
  ...
  () => {
    ...
    const imgUrls = await Promise.all(
     ...
     const formDataCopy = {
      ...
      const docRef =await addDoc(ollection(db,'listings'  ), formDataCopy)
      setLoading(false)
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex">
          ...
          <button
            ...
            value="rent"
            onClick={onChange}
            className={`ml-6 px-7 py-3 font-medium text-sm uppercase shadow-md rounded 
                hover:shadow-lg focus:shadow-lag active:shadow-lg transition duration-150 
                ease-in-out w-full ${
                  type === "sale"
                    ? "bg-white text-black"
        ...
        <div className="flex">
          <button
            ...
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded 
                hover:shadow-lg focus:shadow-lag active:shadow-lg transition duration-150 
                ease-in-out w-full ${
                  !parking ? "bg-white text-black" : "bg-blue-800 text-white"
                }`}
          >
            yes
          </button>
        ...
        <div className="flex">
          <button
            ...
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded 
                hover:shadow-lg focus:shadow-lag active:shadow-lg transition duration-150 
                ease-in-out w-full ${
                  !furnished ? "bg-white text-black" : "bg-blue-800 text-white"
                }`}
          >
            yes
          </button>
        ...
        <textarea
          ...
          className="w-full px-4 py-2 text-xl text-gray-700 bg-white border
             ...
             focus:border-slate-600"
        />
        {!geolocationEnabled && (<div className="flex space-x-6 justify-start mb-6 ">
          <div>
        ...
        <div className="flex">
          <button
            ...
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded 
                hover:shadow-lg focus:shadow-lag active:shadow-lg transition duration-150 
                ease-in-out w-full ${
                  !offer ? "bg-white text-black" : "bg-blue-800 text-white"
                }`}
          >
            yes
          </button>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            multiple
            required
            className="w-full px-3 py-2 text-gray-700 bg-white border border-gray-300 
        ...
        focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
            Create Listing
        </button>
      </form>
    </main>
