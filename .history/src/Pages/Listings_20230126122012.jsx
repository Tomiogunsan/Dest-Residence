  ...
  if (loading) {
    ...
    return (
      ...
      flex justify-center items-center "
        ...
        {shareLinkCopied && (
          <p
            className="fixed top-[19%] right-[5%]
      font-semibold border-2 border-gray-400 rounded-md
       bg-white z-10 p-1"
        ...
        <div className="m-4 flex flex-col md:flex-row  max-w-[1270px] lg:mx-auto m-4 p-4 rounded-lg  
        shadow-lg bg-white lg:space-x-5 ">
          <div className=" w-full h-[200px] lg-[400px]">
            ...
            <div className="flex justify-start items-center space-x-4 w-[75%]">
              <p
                className=" w-full max-w-[200px] bg-red-800 px-4 rounded-md p-1 
            ...
            <ul className="grid grid-cols-2 md:grid-cols-4  md:space-x-2 sm:space-x-10 items-center 
            md:space-x-4  mb-4 text-sm font-semibold">
              <li className=" flex items-center whitespace-nowrap">
                <FaBed className="md:text-lg " />
                {+listing.bedrooms > 1 ? `${listing.bedrooms} Beds` : " 1 Bed"}
              </li>
              <li className=" flex items-center whitespace-nowrap">
                <FaBath className="md:text-lg mr-1" />
                {+listing.bathrooms > 1
                  ? `${listing.bathrooms} Bathrooms`
                  : " 1 Bathroom"}
              </li>
              <li className=" flex items-center whitespace-nowrap">
                <FaParking className="md:text-lg mr-1" />
                {listing.parking ? "Parking spot" : "No parking"}
              </li>
              <li className=" flex items-center whitespace-nowrap">
                <FaChair className="md:text-lg mr-1" />
        ...
        z-10 overflow-x-hidden mt-[225px] md:mt-0"
          >
