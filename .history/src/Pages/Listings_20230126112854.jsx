    ...
    return (
      ...
      font-semibold border-2 border-gray-400 rounded-md
       bg-white z-10 p-1"
        ...
        <div className="grid md:grid-col-2 max-w-[1270px] lg:mx-auto m-4 p-4 rounded-lg  shadow-lg bg-white lg:space-x-5">
          <div className=" w-full h-[200px] lg-[400px]">
            ...
            <div className="flex justify-start items-center space-x-4 w-[75%]">
              <p
                className="bg-red-800 px-4 rounded-md p-1 
            ...
            <ul className="flex-wrap md:flex items-center md:space-x-4 mb-8 text-sm font-semibold">
            ...
            {listing.userRef !== auth.currentUser?.uid && !contactLandlord && (
              <div className="mt-6">
                <button
                  ...
                  className="px-12 py-3 bg-blue-600 text-white font-medium text-sm uppercase 
            rounded-md shadow-md hover:bg-blue-700 hover:shadow-lg 
            focus:bg-blue-700 focus:shadow-lg text-center transition duration-150 ease-in-out 
            "
                >
                  Contact Landlord
                </button>
