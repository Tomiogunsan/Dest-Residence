...
export default function Profile() {
  ...
  const [changeDetail, setChangeDetail] = use
        ...
        <input type="email" id='email' value={email} disabled className='mb-6 w-full px-4
          ...
          <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6'>
            <p className='flex items-center  '>Do you want to change your name?
              <span 
              onClick={}
              className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out duration-200 ml-1 cursor-pointer'>Edit</span>
            </p>
