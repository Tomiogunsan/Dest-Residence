       ...
       <div className='grid md:grid-col-2 max-w-[1270px] lg:mx-auto m-4 p-4 rounded-lg  shadow-lg bg-white lg:space-x-5' >
        <div className=' w-full h-[200px] lg-[400px]'>
          ...
          <div className='flex justify-start items-center space-x-4 w-[75%]'>
            <p className='bg-red-800 px-4 rounded-md p-1 
            text-white text-center font-semibold shadow-md'>{listing.type === 'rent' ? 'Rent' : 'Sale'}</p>
            {listing.offer && (<p className='px-4 bg-green-800 
        ...
        z-10 overflow-x-hidden '>
           <MapContainer center={listing.lat, listing.lng} zoom={13} scrollWheelZoom={false}>
    <TileLayer
