  ...
  return (
    <main>
      ...
      font-semibold border-2 border-gray-400 rounded-md
       ...
       <div className='grid flex-col md:flex-row max-w-[1270px] lg:mx-auto m-4 p-4 rounded-lg  shadow-lg bg-white lg:space-x-5' >
        <div className=' w-full h-[200px] lg-[400px]'>
          ...
          <p className='mt-3 mb-3'> 
            ...
            <ul className='flex items-center space-x-2 sm:space-x-10 mb-8 text-sm font-semibold'>
